package com.cognizant.iiht.searchservice.security;
...
import com.cognizant.iiht.searchservice.SearchserviceApplication;
...
//	}
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable().httpBasic().and().authorizeRequests().antMatchers("/search").permitAll().anyRequest().hasAnyRole();
//		httpSecurity.csrf().disable().httpBasic().and().authorizeRequests().antMatchers("/skill").permitAll().anyRequest().hasAnyRole();
