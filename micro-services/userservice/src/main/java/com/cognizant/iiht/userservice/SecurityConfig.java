...
import com.cognizant.iiht.userservice.security.JwtAuthorizationFilter;
...
//		auth.userDetailsService(inMemoryUserDetailsManager());
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable().httpBasic().and().authorizeRequests().antMatchers("/mentor").permitAll().anyRequest().hasAnyRole();
